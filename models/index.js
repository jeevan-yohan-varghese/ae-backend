...
db.eventVenues = require('./event_venue')(sequelize, Sequelize);
...
db.eventVenues.belongsTo(db.events, { foreignKey: 'eid' })
db.eventVenues.belongsTo(db.venues, { foreignKey: 'vid' })
